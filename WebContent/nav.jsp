...
<div id="nav">
	...
	<li class="nav_title_pre"></li>
		...
		<li class="nav_title ${cur_nav eq 8 ? 'nav_focus' : ''}" id="nav_link_srr">科学研究成果</li><li class="nav_split"></li>
		...
		<li class="nav_title ${cur_nav eq 5 ? 'nav_focus' : ''}" id="nav_link_exchange">国际交流</li><li class="nav_split"></li>
