...
CREATE TABLE `t_prize` (
  ...
  `prizeTeachOrResearch` varchar(1) DEFAULT NULL COMMENT '0教学，1科研',
  `prizeTeacherName` varchar(45) DEFAULT NULL,
...
CREATE TABLE `t_work` (
  ...
  `workAuthorRank` varchar(1) DEFAULT NULL COMMENT '作者排名',
  `workTitle` varchar(50) DEFAULT NULL COMMENT '作著题目',
