...
/**
 * 
 * <p>Title: BsResourceAction.java</p>
 * <p>Description: 资源管理</p>
...
public class ResourceAction extends BaseAction {
	...
	public  void query(){
		...
		try {
			...
			Pager pager = localServiceProxy.queryBsResourceByPage(bsBsResource,Integer.valueOf(rows),Integer.valueOf(page));
