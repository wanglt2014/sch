...
public class BsArticleDAOImpl extends SqlMapClientDaoSupport implements BsArticleDAO {
	 ...
	 * @ibatorgenerated  Sun Apr 05 15:25:30 CST 2015
	 */
	public List selectByExampleWithBLOBs(BsArticleExample example) {
		List list = getSqlMapClientTemplate().queryForList(
				"bs_article.ibatorgenerated_selectByExampleWithBLOBs", example);
		return list;
	}
	 ...
	 * @ibatorgenerated  Sun Apr 05 15:25:30 CST 2015
	 */
	public List selectByExampleWithoutBLOBs(BsArticleExample example) {
		List list = getSqlMapClientTemplate().queryForList(
	 ...
	 * @ibatorgenerated  Sun Apr 05 15:25:30 CST 2015
	 */
	public int updateByExampleWithBLOBs(BsArticle record,
			BsArticleExample example) {
		UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
		int rows = getSqlMapClientTemplate().update(
				"bs_article.ibatorgenerated_updateByExampleWithBLOBs", parms);
		return rows;
	}
	 ...
	 * @ibatorgenerated  Sun Apr 05 15:25:30 CST 2015
	 */
	public int updateByExampleWithoutBLOBs(BsArticle record,
			BsArticleExample example) {
		UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
		int rows = getSqlMapClientTemplate().update(
	 ...
	 * @ibatorgenerated  Sun Apr 05 15:25:30 CST 2015
	 */
	public int updateByPrimaryKeyWithBLOBs(BsArticle record) {
		int rows = getSqlMapClientTemplate().update(
				"bs_article.ibatorgenerated_updateByPrimaryKeyWithBLOBs",
				record);
		return rows;
	}
	 ...
	 * @ibatorgenerated  Sun Apr 05 15:25:30 CST 2015
	 */
	public int updateByPrimaryKeyWithoutBLOBs(BsArticle record) {
		int rows = getSqlMapClientTemplate().update(
