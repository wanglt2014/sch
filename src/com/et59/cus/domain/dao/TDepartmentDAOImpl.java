...
public class TDepartmentDAOImpl extends SqlMapClientDaoSupport implements TDepartmentDAO {
    ...
    public List selectByExampleWithBLOBs(TDepartmentExample example) {
        List list = getSqlMapClientTemplate().queryForList("t_department.ibatorgenerated_selectByExampleWithBLOBs", example);
        return list;
    }
    ...
    public List selectByExampleWithoutBLOBs(TDepartmentExample example) {
        List list = getSqlMapClientTemplate().queryForList("t_department.ibatorgenerated_selectByExample", example);
        return list;
    }
    ...
    public TDepartmentWithBLOBs selectByPrimaryKey(Long departmentid) {
        TDepartment key = new TDepartment();
        key.setDepartmentid(departmentid);
        TDepartmentWithBLOBs record = (TDepartmentWithBLOBs) getSqlMapClientTemplate().queryForObject("t_department.ibatorgenerated_selectByPrimaryKey", key);
        return record;
    }
     ...
     * @ibatorgenerated Tue Mar 24 14:56:05 CST 2015
     */
    public int updateByExampleSelective(TDepartmentWithBLOBs record, TDepartmentExample example) {
     ...
     * @ibatorgenerated Tue Mar 24 14:56:05 CST 2015
     */
    public int updateByExample(TDepartmentWithBLOBs record, TDepartmentExample example) {
        UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
        int rows = getSqlMapClientTemplate().update("t_department.ibatorgenerated_updateByExampleWithBLOBs", parms);
        return rows;
    }
    ...
    public int updateByPrimaryKey(TDepartmentWithBLOBs record) {
        int rows = getSqlMapClientTemplate().update("t_department.ibatorgenerated_updateByPrimaryKeyWithBLOBs", record);
        return rows;
    }
