...
public interface LocalService {
	...
	public  Pager  queryUserListByPage(BsUser user,int pagesize, int currentpage) throws Exception;
	public BsUser queryUserByKey(int id) throws Exception;
	public void deleteUserBykey(int id) throws Exception;
	//产品表
	@SuppressWarnings("rawtypes")
	public  Map  queryProductInfoByPage(BsProductQuery product,int pagesize,int currentpage) throws Exception;
	@SuppressWarnings("rawtypes")
	...
	public  void  updateOrder(String out_trade_no,String trade_no,int trade_status)throws Exception;
	@SuppressWarnings("rawtypes")
	public  Map queryOrderForPage(BsOrder order,int pagesize,int currentpage) throws Exception;
	@SuppressWarnings("rawtypes")
	...
	@SuppressWarnings("rawtypes")
	public  Map  queryUserServiceByPrimaryKey(BsUserservice  bsUserservice) throws Exception;
	@SuppressWarnings("rawtypes")
	public  Map  updateUserService(BsUserservice  bsUserservice) throws Exception;
	@SuppressWarnings("rawtypes")
	public  Map queryUserServiceForPage(BsUserservice bsUserservice,int pagesize,int currentpage) throws Exception;
	...
	public  Pager queryEmailJsonForpage(BsEmailquery bsemail,int startrecord, int endrecord) throws Exception;
	public  BsEmail queryEmailByIdJson(long id) throws Exception;
	//文章表
	@SuppressWarnings("rawtypes")
	public Map queryArticleByTypeForPage(BsArticleQuery bsArticle,int pagesize,int currentpage) throws Exception;
	...
	//供应商
	public  Pager  querySupplierByPage(BsSupplier bsSupplier ,int pagesize,int currentpage) throws Exception;
	...
	//产品分类
	public  Pager queryProductcategoryBypage(BsProductcategory bsProductcategory,int pagesize,int currentpage) throws Exception;
	public void  deleteBsProductcategory(int id) throws Exception;
	public void saveBsProductcategory(BsProductcategory bsProductcategory) throws Exception;
	public void udateBsProductcategory(BsProductcategory bsProductcategory) throws Exception;
	...
	//查询资源表
	public  List<BsResource> queryResourcebyuserId(String userid) throws Exception;
	public  Pager  queryBsResourceByPage(BsResource bsResource, int pagesize,int currentpage) throws Exception;
	...
	//角色查询
	public  Pager  queryBsRoleByPage(BsRole bsRole, int pagesize,int currentpage) throws Exception;
	...
	//查询角色对应的资源
	public   List<BsRoleResource>  queryBsRoleResourceByroleid(int roleid) throws Exception;
	...
	public  Pager    queryApibyPage(OpenApi openApi, int pagesize, int currentpage) throws Exception;
	...
	//应用管理
	public  Pager    queryAppbyPage(OpenApp openApp, int pagesize, int currentpage) throws Exception;
	...
	//開放日志
	public  void  insertOpenLog(String accesstoken,String apiUrl) throws Exception;
	public  Pager  queryopenLogbyPage(OpenLogQuery openLog, int pagesize, int currentpage)throws Exception;
	//访问权限表
	...
	public  Pager  queryOpenOauthbyPage(OpenOauth openoauth, int pagesize, int currentpage)throws Exception;
	...
	public  List<BsPagestatic> querypagestatic(BsPagestatic bsPagestatic)throws Exception;
	//留言
	public  void   insertleavemessage(BsLeavemessage bsLeavemessage)throws Exception;
	public  Pager  queryleavemessagebyPage(BsLeavemessage bsLeavemessage, int pagesize, int currentpage)throws Exception;
	//系统变量
	public  List<BsSystem> queryBsSystem()throws Exception;
	public  void  cacheSystemConstatnt() throws Exception;
	//action执行时间统计
	public  List<TjActiontime> queryActionTime(TjActiontime tjActiontime)  throws Exception;
	...
	public Pager queryaddressbyPage(BsAddress bsAddress,int pagesize, int currentpage) throws Exception ;
	//支付
	public  OrderVo Pay(BsAddress bsAddress,Shopcart shopCart,String identity) throws Exception;
